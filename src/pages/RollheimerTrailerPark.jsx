      ...
      <div className="container">
        ...
        <div className="grid">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                Within the framework of Abstract City, the use of open space and
                the special form of living in the Rollheimer trailer park should
                be re-structured. In terms of urban planning, the green space
                should be opened up and apartments should be planned, for the
                Rollheimers to be cared for in their old age without losing
                their place of residence.
              </p>
              <br />
              <p>
                The new design should house apartments for 20 Rollheimers and 20
                students+guests.
              </p>
            </div>
          </div>
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                In the existing community, privacy is as equally important as
                community. Creating spatial variation of different privacies was
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                By multiplying this spatial configuration a variety of different
                neighbourships can be created.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The ground floor function as the communal grounds. Workshops, a
                café, and additional space can be used by the residents and
                local citizens equally.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The smaller building will provide rooms for 20 students and
                short-term guests. On the first floor is a double-height common
                area for students to study and eat. Over exterior kitchen and
                laundrettes, stairs lead to each student&apos;s private room.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The rooms are connected to the common area via a circular
                walkway. Sliding elements allow the private rooms to be opened
                or closed. Short-term visitors can be accommodated on the top
                floor.
              </p>
            </div>
          </div>
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                Guests access their rooms directly through a corridor via stairs
                located outside. Each unit has its own shower and toilet, with
                views into the greenery of the surrounding trees. Skylights
                vertically light the top floor and the student common room
                below.
              </p>
            </div>
          </div>
...
export default RollheimerTrailerPark;
