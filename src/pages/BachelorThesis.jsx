        ...
        <div className="grid">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The University of the Arts fashion faculty is in need of an
                extension in order to hold newer and technologically more
                advanced studios. The vacant lot given is located between the
                fire wall of the existing fashion faculty building of the 1900s
                and the post war modern Technological University building. The
                new extension should hold studios for 20 students.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                Keeping the plots current use as path to easily reach other
                buildings was crucial for the design process and lead to the
                building being lifted up.
              </p>
              <br />
              <p>
                Double heightened cuts into the building function as interior
                paths. An additional exterior staircase and elevator were added.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                ​Design in fashion is characterized by three central work steps:
                sewing, tailoring and mock-up. The functions that were spatially
                separated in the old building are now brought together in the
                open space. Work steps flow into each other and enable more open
                studying with more exchange between the students.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The building functions as a connector between the two existing
