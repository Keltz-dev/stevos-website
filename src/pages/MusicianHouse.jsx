      ...
      <div className="container">
        <div className="grid">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The building, which is divided into three cubes, wraps itself
                around the existing trees and integrates them into the
                architecture through inner courtyards and forecourts. The street
                façade remains closed, except for the glazed stairways, in order
                to allow the narrow site intimacy.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                In the basement, the building faces the centrally located
                courtyard. The upper floor opens to the roof terraces. In the
                basement, there is a living room with a kitchen, a library and a
                studio. The rooms adjust in depth according to their
                topographical position. This creates a flowing floor landscape
                within the first floor and further defines the openly connected
                rooms. Two separately accessible sleeping areas are located on
                the upper floor. This creates a retreat for children and
                parents, or guests and residents.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                {" "}
                The three functions to be accommodated - living room, library
                and studio - generate three cubes that are to be interconnected.
                The mobility of the individual elements makes it possible to
                respond strongly to the building site.
              </p>
            </div>
          </div>
          <div className="grid-item">
