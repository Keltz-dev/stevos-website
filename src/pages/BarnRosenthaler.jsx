  ...
  return (
    <>
      <div className="container">
        ...
        <div className="grid">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The project is located in Weinbergsweg 1 overlooking Rosenthaler
                Platz in Berlin. The busy street offers a variety of
                restaurants, bars, a hostel and a bakery.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The old bookshop should be transformed into a new café with
                80sqm of interior and 20sqm of exterior space. The central
                element: the bar, divides the room into separate spatial
                situations.
              </p>
            </div>
          </div>
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                The possibility to sit at the bar and see closely how your
                coffee is brewed not only brings the consumer closer to the
                barista, but to the product itself.
              </p>
            </div>
          </div>
          <div className="grid-item">
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                Through an archway a more private reading room with magazines
                and books about coffee commemorates the previous use of the
                shop.
              </p>
            </div>
          </div>
          ...
          <div className="grid-item">
            <div className="text-wrapper montserrat-normal">
              <p>
                Oil finished oak wood was used for the bar as well as for all
                furniture, including the design of all chairs and tables.
              </p>
            </div>
          </div>
          <div className="grid-item">
        ...
        <div className="centered">
          <h3 className="inter-normal max-20">with The Barn GmbH 2020</h3>
        </div>
        <div className="centered">
          <div className="text-wrapper montserrat-normal">
...
export default BarnRosenthaler;
